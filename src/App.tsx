        ...
        <div className="container relative z-10 text-center text-white">
          <Reveal>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="#services" className="btn-white-outline !bg-white !text-green-primary shadow-xl !px-10">
            ...
            <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {[
                ...
                { icon: <CheckCircle2 className="w-5 h-5 text-green-accent" />, text: "Free Farm Site Assessment" },
              ].map((badge, idx) => (
